...
export const fr = {
  ...
  bikes: {
    ...
    items: {
      ...
      custom: {
        name: "Custom",
        blurb: "Empattement long, carter apparent, bras oscillant dégagé.",
      },
    },
    stripRuns: {
      frontFender: "Sous le garde-boue avant",
      fork: "Fourche",
      fairingEdge: "Rebord de carénage",
      engineCase: "Autour du carter",
      swingarm: "Bras oscillant",
      frameRail: "Rail de cadre",
      subframe: "Boucle arrière",
      rearHugger: "Sous le garde-boue arrière",
    },
