...
export const en: Dictionary = {
  ...
  bikes: {
    ...
    items: {
      ...
      custom: { name: "Custom", blurb: "Long wheelbase, exposed cases, clear swingarm." },
    },
    stripRuns: {
      frontFender: "Under the front fender",
      fork: "Fork",
      fairingEdge: "Fairing edge",
      engineCase: "Around the engine case",
      swingarm: "Swingarm",
      frameRail: "Frame rail",
      subframe: "Rear subframe",
      rearHugger: "Under the rear hugger",
    },
